# DEPRECATED - This directory is only for reference

Offline Japanese text-to-speech (TTS) on Android for **Codename One** apps, powered by **Open JTalk** with the **Mei (Normal)** voice.

This directory provides **two reference projects** (Codename One + Android Studio) that demonstrate a working Japanese text-to-speech demo. I used these two projects to create the CN1Lib. However, you should use the CN1Lib and ignore this directory.

The voice quality in this directory is not good.
